class Gene():
    ...
    ########################################################            
    # Homework Week 3, Problem 4
    #
    # Complete this function.
    # You must not change other parts of this class to keep it work properly.
    #
    def mutate_dna_seq(self, pos, base):
        self.dna_seq = self.dna_seq[:pos] + base + self.dna_seq[pos+1:]
